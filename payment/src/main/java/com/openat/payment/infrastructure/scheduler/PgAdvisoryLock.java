...
// 대사 배치의 다중 replica 중복 실행 방지(7/15 dayplan "ShedLock 적용" 요구, WS-0) — Postgres 세션 advisory lock으로
// 최소 구현. 정식 ShedLock(Redis, 7-14 plan D5)이 들어오면 이 클래스는 걷어내고 @SchedulerLock으로 교체 예정.
@Component
