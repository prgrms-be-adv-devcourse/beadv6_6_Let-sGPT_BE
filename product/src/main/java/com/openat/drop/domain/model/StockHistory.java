...
public class StockHistory {
  ...
  @Column(name = "drop_id", nullable = false, updatable = false, comment = "드롭 ID(값 참조), 원장 감사 독립")
  private UUID dropId;
  ...
  private StockHistory(
      UUID dropId, UUID orderId, UUID buyerId, StockChangeType changeType, int quantity) {
    this.dropId = dropId;
    this.orderId = orderId;
    this.buyerId = buyerId;
    this.changeType = changeType;
    if (changeType == StockChangeType.DEDUCT) {
