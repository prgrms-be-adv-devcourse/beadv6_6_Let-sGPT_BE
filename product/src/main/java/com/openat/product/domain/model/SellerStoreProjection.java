...
public class SellerStoreProjection {
  ...
  @Column(nullable = false, length = 50, comment = "스토어 표시명(member SellerInfo.storeName 투영)")
  ...
  private SellerStoreProjection(UUID sellerInfoId, String storeName) {
    this.sellerInfoId = sellerInfoId;
    this.storeName = storeName;
  }

  public boolean changeStoreName(String storeName) {
