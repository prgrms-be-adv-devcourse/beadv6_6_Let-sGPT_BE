...
public class OrderRepositoryAdaptor implements OrderRepository {
  ...
  @Override
  public List<UUID> findExpiredPaymentPendingIds(Instant now, Pageable pageable) {
    return orderJpaRepository.findExpiredPaymentPendingIds(
        OrderStatus.PAYMENT_PENDING, now, pageable);
  }
}
